...
function hideLogoText() {
  ...
  if (!isScrollTopZero && !logoTextIsClosed) {
    ...
    document.querySelector(".nav__logo").className = "nav__logo_open global_flex-center"
    document.querySelector(".nav__main_container").className = "nav__main_container_open global_flex-center"
    ...
    document.querySelector(".nav__logo_open").className = "nav__logo global_flex-center"
    document.querySelector(".nav__main_container_open").className = "nav__main_container global_flex-center"
...
function clickMenu() {
  if (!isMenuActive) {
    ...
    document.querySelector("header.mobile .nav__logo").className = "nav__logo global_display-none"
    isMenuActive = true;
    ...
    document.querySelector("header.mobile .nav__logo").className = "nav__logo global_flex-center"
    isMenuActive = false;
  }
}
